...
if (!cookie('notnewbie')) {
  ...
  var overlay = new HugeOverlay(html, { background: 'url(https://daks2k3a4ib2z.cloudfront.net/54b5dacca1dc10190edce926/54c38ee62d5eaa62178ffc67_header-bg.jpg)' });
  overlay.appendTo('body');
  setTimeout(function() { overlay.toggle(); }, 1000);
