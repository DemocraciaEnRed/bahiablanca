...
var UserSchema = new Schema({
  ...
  , phone: { type: String, trim: true, match: regexps.phone, unique: true }
...
UserSchema.plugin(passportLocalMongoose, {
  usernameField: 'phone',
  userExistsError: 'Ya existe un usuario con el número de celular %s'
});
...
UserSchema.virtual('incomplete').get(function() {
  return !(this.email && this.firstName && this.lastName) || undefined;
});
