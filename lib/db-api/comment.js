...
exports.getFor = function getFor(query, paging, fn) {
  ...
  .exec(function(err, comments) {
    ...
    var opts = { path: 'author', select: 'id firstName lastName fullName email avatar official' };
...
exports.replies = function replies(id, fn) {
  ...
  .exec(function(err, comment) {
    ...
    var opts = { path: 'replies.author', select: 'id firstName lastName fullName email avatar official' };
...
exports.reply = function reply(commentId, reply, fn) {
  ...
  Comment.findById(commentId, function(err, comment) {
    ...
    comment.save(function(err, saved) {
      ...
      var opts = { path: 'replies.author', select: 'id firstName lastName fullName email profilePictureUrl' };
      ...
      User.populate(comment, opts, function(err, comment) {
        ...
        if (notifier.enabled() && comment.author != reply.author.id) {
          ...
          var eventName = 'reply-argument'

          var lawUrl = utils.buildUrl(config, { pathname: '/law/' + comment.reference });
