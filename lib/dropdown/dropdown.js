 ...
 *  var d = dropdown({ items: [{ id: 0, text: 'Banana' }, { id: 1, text: 'Apple' }] });
 *  d.appendTo('.selector');
 *
 * Options:
 *  items {Array} Array with objects with properties id and text
 *  change {Function} Executed when a selection is made. Passes the new value as argument.
 *  defaultValue {String}
 *
 */
...
function Dropdown (opts) {
  ...
  if (opts.defaultValue) {
    ...
    this._value = { id: '0', text: t('dropdown.all') };
  }
