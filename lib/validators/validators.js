...
exports.phone = function(val, option, fn) {
  val = val.trim();
  fn(!regexps.phone.test(val) && '' != val ? t('validators.invalid.phone') : null);
};

exports.dni = function(val, option, fn) {
  val = val.trim();
  fn(!regexps.dni.test(val) && '' != val ? t('validators.invalid.dni') : null);
};
...
exports.party = function(val, option, fn) {
  val = val ? val.trim() : '';
  fn(!regexps.party.test(val) && '' != val ? t('validators.invalid.party') : null);
};
